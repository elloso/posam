...
{	 
	public function __construct()
	{
		...
		$this->data['page_title'] = 'Report01 - List of Items';
	...
	public function REP01() {	
		...
		$this->table->set_heading('<th width="6%" height="28"><strong>Code</strong></th>', 
								  '<th width="16%" height="28"><strong>Name</strong></th>',
								  '<th width="10%" height="28"><strong>Brand</strong></th>',
								  '<th width="10%" height="28"><strong>Category</strong></th>',
								  '<th width="10%" height="28"><strong>Unit</strong></th>',
								  '<th width="7%" height="28"><strong>Ordering Point</strong></th>',
								  '<th width="6%" height="28"><strong>Safety Stock</strong></th>',
								  '<th width="8%" height="28"><strong>Price Date</strong></th>',
			                      '<th width="7%" height="28" align="right"><strong>Price</strong></th>',
			                      '<th width="8%" height="28" align="right"><strong>Quantity</strong></th>',
			                      '<th width="10%" height="28" align="right"><strong>Total</strong></th>') ;
		...
		if ($REP01 == null) {
			...
			foreach ($REP01 as $rs):
				...
				$cell2 = array('data' => $rs->item_name, 'width' => '16%');
				$cell3 = array('data' => $rs->brand, 'width' => '10%');
				$cell4 = array('data' => $rs->category_name, 'width' => '10%');
				$cell5 = array('data' => $rs->unit_name, 'width' => '10%');
				$cell6 = array('data' => $rs->ordering_point, 'width' => '7%');
				$cell7 = array('data' => $rs->safety_stock, 'width' => '6%');
				$cell8 = array('data' => $rs->price_date, 'width' => '8%');
				$cell9 = array('data' => $rs->item_price, 'width' => '7%', 'align' => 'right');				
				$cell10 = array('data' => $rs->quantity, 'width' => '8%', 'align' => 'right');
				$cell11 = array('data' => $rs->total, 'width' => '10%', 'align' => 'right');		
