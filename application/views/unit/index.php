    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createUnit', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal" onclick="createFunc()"><?php echo 'Add Unit'; ?></button>
          <?php endif; ?>

        <?php if(in_array('viewUnit', $user_permission)): ?>
           <?php echo '<a href="'.base_url('report_setting/report_setting/unit').'" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>'; ?>
          <br /> <br />
        <?php endif; ?>
      ...
      <form role="form" action="<?php echo base_url('unit/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="unit_name">Name<font color="red"> *</font></label>
            <input type="text" class="form-control" id="unit_name" name="unit_name" autocomplete="off">
          </div>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('unit/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_unit_name">Name<font color="red"> *</font></label>
            <input type="text" class="form-control" id="edit_unit_name" name="edit_unit_name" autocomplete="off">
          </div>
...
// edit function
function editFunc(unit_id)
{ 
  $("#updateForm")[0].reset();
  $("#updateForm .form-group").removeClass('has-error').removeClass('has-success');  
  $(".text-danger").remove(); 
  $.ajax({
    url: 'fetchUnitDataById/'+unit_id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
