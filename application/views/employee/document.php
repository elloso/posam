 ...
 <div id="document" class="tab-pane fade <?php echo (($active_tab === 'document') ? 'in active' : '') ?>">
      ...
      <div class="box">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12 col-xs-12">                            
              ...
              <?php echo form_open_multipart('employee/uploadDocument') ?>
              <?php echo "<table width='100%'>" ?>
              <?php echo "<tr>" ?>
              <?php echo "<td width='10%' align=left><input type='file' required='required' name='employee_document' id='employee_document' size='60'  /></td>" ?>  
        ...
        <div class="box-footer">
            <a href="<?php echo base_url('employee/') ?>" class="btn btn-warning">Close</a>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeDocumentModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('employee/removeDocument') ?>" method="post" id="removeFormDocument">
...
var document_employee_id = <?php echo $employee_data['employee_id']; ?>;
var document_type_id = 'all';  //for all type of documents

  $("#DocumentEmployeeNav").addClass('active');

  // initialize the datatable 
  manageTableDocument = $('#manageTableDocument').DataTable({
    'ajax': {
          url: base_url + 'employee/fetchEmployeeDocument/',
          type: 'POST',
          dataType: 'json',
          data: {document_employee_id: document_employee_id, document_type_id: document_type_id},
          },        
    'order': [[0, "asc"]]
  });
